...
@Getter
@AllArgsConstructor
public class UpdateSelfJobExperienceRequest extends AbstractSelfJobExperienceRequest {
    @ValidUUID
    private UUID uuid;
    ...
    public JobExperience toUpdatedJobExperience(JobExperience jobExperience, User user, List<Technology> technologies) {
        return JobExperience.builder()
                .id(jobExperience.getId())
                .uuid(jobExperience.getUuid())
